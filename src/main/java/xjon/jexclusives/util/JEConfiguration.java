...
public class JEConfiguration {
	...
	public static final String CUSTOM_MODPACK_SLUG_NAME = "Slug name for our custom modpacks. Don't change";
	public static final String URL_FOR_REMOTE_CONFIGS_NAME = "Url (this) + customModpackSlug + .json = remoteConfigsUrl";
